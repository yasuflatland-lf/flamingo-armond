// Code generated by goyacc -o ./pkg/notion/parser.go -p yy ./pkg/notion/parser.y. DO NOT EDIT.

//line ./pkg/notion/parser.y:2
package notion
...
//line ./pkg/notion/parser.y:34
		{
			yyVAL.nodes = yyDollar[1].nodes
			currentParser.setNodes(yyDollar[1].nodes)
		}
	case 2:
		yyDollar = yyS[yypt-2 : yypt+1]
//line ./pkg/notion/parser.y:38
		{
