...
type Resolver struct {
    ...
    // ... plus LearnUC, SwipeUC, AuthSvc, DictionaryUC, AdminUserUC,
...
// ... swipeUC, dictionaryUC, adminUserUC, adminRoleUC, lastViewedCardgroupUC, learnUC

resolvers := resolver.NewResolver(
    userUC, cardgroupUC, cardUC, swipeUC, authSvc, dictionaryUC,
