...
Reference: `frontend/src/lib/apollo/graphql-errors.ts` (`liftGraphQLCodes`) is the canonical implementation, consumed by `frontend/src/app/admin/roles/admin-roles-client.tsx`, `frontend/src/app/admin/users/admin-user-profile-sheet.tsx`, and `frontend/src/app/profile/profile-form.tsx`.
