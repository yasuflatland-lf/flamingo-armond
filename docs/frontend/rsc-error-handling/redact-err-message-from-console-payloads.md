...
**How to apply:** every `console.warn` / `console.error` that catches a backend GraphQL error or a Supabase auth error MUST omit `err.message` from the structured payload. This applies in both RSC pages and client components:
